...
Tags: wordpress migration, migrate wordress, move wordpress, wordpress transfer, clone wordpress
Stable tag: 11.4.0
Version: 11.4.0
...
= Transferito Documentation =
[Get Started with Transferito](https://knowledge.transferito.com/getting-started/) view our guides to see how to get started!
...
Fixed settings not saving correctly on first save
Added Upload Chunk Size field
Fixed frame not loading correctly
Fixed slow migrations

= 11.2.5 - 28/02/25 =

Database import - Bug Fix
Blank Screen - Bug Fix
Archive Extraction - Bug Fix

= 11.2.0 - 20/02/25 =

[BugFix] - Database Import failure fix for some migration users
