...
<div class="wrap">
    ...
    <div class="transferito-header">
        ...
        <div class="transferito-header__actions">
            ...
            <div class="transferito-header__action-button">
                <a href="https://knowledge.transferito.com/getting-started" class="transferito-button transferito-button__primary--blue transferito-button--small transferito-log-event" data-event-name="viewQuickStartGuide" target="_blank">QUICKSTART GUIDE</a>
            </div>
    ...
    <div id="upgradeToPremiumPaymentModal" class="transferito__hide-element">
        <?php echo loadTemplate( 'parts/iframe', [
            'image'             => 'sent-success',
            'title'             => 'Request a Hosting Guide',
            'mainContent'       => 'We apologize for not having a guide for your hosting provider. However, we would be more than happy to create one for you. Just enter your details below. Thank you!',
            'iframeURL'         => 'https://transferito.com/pricing/card'
        ]); ?>
    </div>
