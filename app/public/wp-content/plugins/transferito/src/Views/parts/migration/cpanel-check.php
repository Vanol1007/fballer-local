...
<?php if ($data['metRequirements']): ?>
    ...
    <div class="transferito__three-columns">
        ...
        <div id="destinationURLScreen" class="transferito__column transferito__main-column">
            ...
            <div class="transferito__content-container">
                <div class="transferito-destination-url">
                    ...
                    <div class="transferito-destination-url__input transferito-destination-url__input--margin-top">

                        <label class="transferito-input__checkbox--label transferito-text__p1--bold">
                            <input type="checkbox"
                                   class="transferito-input__checkbox transferito-form-element"
                                   id="localSiteMigration"
                                   name="local_site_migration">
                            Migrate to your local environment
                        </label>
                        <div class="transferito-database-authentication__checkbox--content transferito-text__small">
                            Only check this if you want to migrate your site to your development machine
                        </div>
