<?php
    ...
    $isLocalMigration = $transferMethod === 'localSiteMigration';
?>
...
<div class="transferito-navigation">
        ...
        <div class="transferito-navigation__item">
            ...
            <div class="transferito-navigation__item-details">
                ...
                <?php if ($data['chooseMethod'] === 'completed'): ?>
                    <div class="transferito-navigation__item-information">
                        <div class="transferito-navigation__content transferito-text__small">
                            <?php if ($transferMethod === 'cpanel'): ?>cPanel<?php endif; ?>
                            <?php if ($transferMethod === 'manual'): ?>FTP<?php endif; ?>
                            <?php if ($transferMethod === 'localSiteMigration'): ?>Local<?php endif; ?>
                        </div>
                        <?php if (isset($data['startMigration']) && $data['startMigration'] !== 'active'): ?>
    ...
    <?php if (isset($data['cPanelAuthentication']) && !$isLocalMigration): ?>
        <div class="transferito-navigation__item">
    ...
    <?php if (isset($data['selectDomain']) && !$isLocalMigration): ?>
        <div class="transferito-navigation__item">
    ...
    <?php if (isset($data['ftpAuthentication']) && !$isLocalMigration): ?>
        <div class="transferito-navigation__item">
            ...
            <div class="transferito-navigation__item-details">
                ...
                <?php if ($data['ftpAuthentication'] === 'completed'): ?>
                    <?php
                        ...
                        $ftpPassword = stripslashes(sanitize_text_field($ftpDetail['ftpPass']));
                    ?>
                    <div class="transferito-navigation__item-information">
                        ...
                        <div class="transferito-navigation__content transferito-text__small"><?php echo $ftpPassword;?></div>
    ...
    <?php if (isset($data['selectDirectory']) && !$isLocalMigration): ?>
        <div class="transferito-navigation__item">
    ...
    <?php if (isset($data['databaseAuthentication']) && !$isLocalMigration): ?>
        <div class="transferito-navigation__item">
            ...
            <div class="transferito-navigation__item-details">
                ...
                <?php if ($data['databaseAuthentication'] === 'completed'): ?>
                     ...
                     */
                    $ftpDetail = get_transient('transferito_manual_server_detail');
                    $dbPassword = stripslashes(sanitize_text_field($ftpDetail['dbPass']));
                    ...
                    <div class="transferito-navigation__item-information">
                        ...
                        <div class="transferito-navigation__content transferito-text__small"><?php echo $dbPassword;?></div>
                        <?php if (isset($data['startMigration']) && $data['startMigration'] !== 'active'): ?>
                        <div class="transferito-navigation__link transferito-text__small--semi-bold">Update</div>
                        <?php endif; ?>
                    </div>
