...
<div class="transferito__three-columns">
        ...
        <div id="selectMigrationMethodScreen" class="transferito__column transferito__main-column">
            ...
            <div class="transferito__content-container">
                ...
                <div class="transferito-migration-method">
                    ...
                    <div class="transferito-migration-method__action-buttons">
                        ...
                        <button id="selectTransferitoMigrationMethod" class="transferito-button transferito-button__primary transferito-button--small transferito__select-migration-method">CONTINUE</button>
                    </div>
