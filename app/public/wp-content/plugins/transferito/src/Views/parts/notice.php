    ...
    <div class="transferito-notice__container">
        ...
        <?php if (isset($data['closeButton']) && $data['closeButton']) : ?>
            <div class="transferito-notice__action-button">
                <?php if (isset($data['closeCssClasses'])) : ?>
                    <button class="transferito-button transferito-button__secondary transferito-button--medium transferito__modal--close <?php echo implode(' ', $data['closeCssClasses']); ?>">CLOSE</button>
                <?php endif; ?>
                <?php if (!isset($data['closeCssClasses'])) : ?>
