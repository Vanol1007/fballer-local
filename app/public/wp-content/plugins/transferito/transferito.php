 ...
 * Description:  The easiest 1-Click WordPress Migration plugin that will migrate, clone, transfer and move your WordPress site to any host in seconds.
 * Version:      11.4.0
 * Author:       Transferito
...
define( 'TRANSFERITO_CHUNK_SIZE',      (10 * 1024 * 1024) );
define( 'TRANSFERITO_VERSION',         '11.4.0' );
define( 'TRANSFERITO_MAX_ALLOWED',     (250 * 1024 * 1024) );
define( 'TRANSFERITO_ZIP_LIMIT',       (32 * 1024 * 1024) );
define( 'TRANSFERITO_DB_LIMIT',        (0.65 * 1024 * 1024) );
